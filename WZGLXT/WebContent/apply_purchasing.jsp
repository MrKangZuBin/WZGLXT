...
<script type="text/javascript">
	...
	function confirm(){
		alert("添加物品");
		window.location.href="${pageContext.request.contextPath }/iteminfo/selItem.do";
	}
// 	function outPut() {
// 		alert("对不起你还没有添加物品！");
// 	}
				...
				<div id="popuporder" class="popup" style="padding: 20px">
					...
					<form class="form-inline" method="post">
						<fieldset>
							<table>
								<tr align="center">
									<td><label>采购单号 </label> <input type="text" id="purID" name="purID"
										class="form-control select-lg" disabled="disabled" /></td>
									<td><label>申请人</label> <input type="text" name="userName"
										value="${userName }" class="form-control select-lg"
										disabled="disabled" /></td>
									<td><label>部门</label> <input type="text" id="oname" name="oname"
										class="form-control select-lg" disabled="disabled" /></td>
							...
							<div>
								...
								<label>最后处理人</label> <input type="text" name="lastName"
									class="form-control select-lg" />
								<label>最后处理时间</label> <input type="text" name="getdate"
									class="form-control select-lg" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
							</div>
							<div align="center">
