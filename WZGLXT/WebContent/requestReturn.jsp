					...
					<form class="form-inline">
						<fieldset>
							<table>
								<tr align="center">
									<td><label>退货单号 </label> <input type="text" id="returnID"
										name="" class="form-control select-lg" readonly="readonly" /></td>
									<td><label>创建人</label> <input type="text"
										class="form-control select-lg" readonly="readonly"
										value="${userName }" name=""/></td>
									<td><label>状态</label><input type="text" value="未提交"
										class="form-control select-lg" readonly="readonly" name=""/></td>
								</tr>

								<tr align="center">
									<td><label>退货说明</label> <input type="text"
										class="form-control select-lg" name=""/></td>
									...
									<td><input type="radio" class="form-control select-lg"
										name="wuliao" />IMPA物料 <input type="radio"
										class="form-control select-lg" name="wuliao" />普通物品</td>
								</tr>
							</table>
							...
							<div>
								...
								<a href="${pageContext.request.contextPath }/iteminfo/selrItem.do"><button
							...
							<table id="caigouleibiao"
								...
								<tr>
									...
									<td><label>最后处理人</label> <input type="text"
										value="${userName }" class="form-control select-lg" /></td>
								...
								<tr>
									<td align="center" colspan="3">
										...
										<button class="btn btn-warning" type="submit">保存并提交</button>
										<button class="btn btn-warning" type="button"
